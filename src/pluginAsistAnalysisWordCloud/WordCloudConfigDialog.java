 ...
 * @author Lathy
 */
public class WordCloudConfigDialog extends JDialog implements DocumentListener {
    ...
    public WordCloudConfigDialog() {
        super(null, "Asist Analysis Configuration", Dialog.ModalityType.APPLICATION_MODAL);
    }

    WordCloudConfigDialog(ProjectOrganization organization) {
        super(null, "Asist Analysis Configuration", Dialog.ModalityType.APPLICATION_MODAL);
        org = organization;
