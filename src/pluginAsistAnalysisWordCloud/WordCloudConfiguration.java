 ...
 * @author Lathy
 */
public class WordCloudConfiguration implements PlayableAnalyzableConfiguration  {
    ...
    private List<WordCloudVisualization> playables;
    private List<WordCloudVisualization> visualizables;
    
    private static final Logger logger = Logger.getLogger(WordCloudConfiguration.class.getName());
    ...
    public WordCloudConfiguration(String name) {

    }

    public WordCloudConfiguration() {
    ...
    public void addPlayable(WordCloudVisualization playable) {
        playables.add(playable);
    }

    public void addVisualizable(WordCloudVisualization visualizable) {
    ...
    public File toFile(File parent) {
        File f = new File(parent, "wordCloud_"+id+".xml");
        try {
            f.createNewFile();
    ...
    public Configuration fromFile(File file) {
        ...
        if (fileName.contains("_") && fileName.contains(".")) {
            ...
            WordCloudConfiguration config = new WordCloudConfiguration ();
            config.id = name;
            return config;
        }
        return null;
